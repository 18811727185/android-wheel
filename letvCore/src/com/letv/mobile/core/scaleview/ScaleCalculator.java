...
public class ScaleCalculator {
    ...
    public void scaleBounds(Rect rect) {
        if (rect == null || this.isBaseSize()) {
            return;
        }
        rect.left = this.scaleWidth(rect.left);
        rect.right = this.scaleWidth(rect.right);
        rect.top = this.scaleHeight(rect.top);
        rect.bottom = this.scaleHeight(rect.bottom);
    }
