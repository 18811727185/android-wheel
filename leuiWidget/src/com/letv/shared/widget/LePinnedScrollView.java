 ...
 *
 */
public class LePinnedScrollView extends ScrollView {

	/**
	 * Tag for views that should stick and have constant drawing. e.g. TextViews, ImageViews etc
	 */
	public static final String STICKY_TAG = "pinned";
	...
	public LePinnedScrollView(Context context) {
		this(context, null);
	}

	public LePinnedScrollView(Context context, AttributeSet attrs) {
		this(context, attrs, android.R.attr.scrollViewStyle);
	}

	public LePinnedScrollView(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs,
		        R.styleable.LePinnedScrollView, defStyle, 0);

    		final float density = context.getResources().getDisplayMetrics().density;
    		int defaultShadowHeightInPix = (int) (DEFAULT_SHADOW_HEIGHT * density + 0.5f);

    		mShadowHeight = a.getDimensionPixelSize(
        		R.styleable.LePinnedScrollView_lePinnedShadowHeight,
        		defaultShadowHeightInPix);

    			int shadowDrawableRes = a.getResourceId(
        		R.styleable.LePinnedScrollView_lePinnedShadowDrawable, -1);
