...
public class DragSortGridUtils {
    /**
     ...
     * @param indexTwo
     */
    public static void reorder(ArrayList<Object> list, int indexFrom, int indexTwo) {
     ...
     */
    public static void swap(ArrayList<Object> list, int firstIndex, int secondIndex) {
